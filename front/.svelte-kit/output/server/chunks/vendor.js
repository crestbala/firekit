...
async function render_data(event, route, options2, manifest, state2, invalidated_data_nodes, trailing_slash) {
  if (!route.page) {
    return new Response(void 0, {
      status: 404
    });
...
const MAX_DEPTH = 10;
async function render_page(event, page2, options2, manifest, state2, nodes, resolve_opts) {
...
async function respond(request, options2, manifest, state2) {
  const url = new URL(request.url);
...
const options = {
  ...
  templates: {
    app: ({ head, body: body2, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n    <head>\n        <title>The Pokémon Software</title>\n        <meta charset="utf-8" />\n        <link rel="icon" href="' + assets2 + '/favicon.png" />\n        <meta name="viewport" content="width=device-width, initial-scale=1" />\n        <base href="/" />\n        ' + head + '\n    </head>\n\n    <body\n        data-sveltekit-preload-data="hover"\n        class="text-sm text-slate-900 overscroll-none font-system"\n    >\n        <div style="display: contents">' + body2 + "</div>\n    </body>\n</html>\n",
